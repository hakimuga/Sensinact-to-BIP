...
* generated by Xtext
*/
package org.eclipse.sensinact.studio.language.ui.contentassist.antlr;
...
public class SensinactParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.sensinact.studio.language.ui.contentassist.antlr.internal.InternalSensinactParser createParser() {
		org.eclipse.sensinact.studio.language.ui.contentassist.antlr.internal.InternalSensinactParser result = new org.eclipse.sensinact.studio.language.ui.contentassist.antlr.internal.InternalSensinactParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getAlternatives(), "rule__DSL_CLOCK_STOCHASTIC__Alternatives");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getAlternatives_1_4(), "rule__DSL_CLOCK_STOCHASTIC__Alternatives_1_4");
					...
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getGroup_0(), "rule__DSL_CLOCK_STOCHASTIC__Group_0__0");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getGroup_0_2(), "rule__DSL_CLOCK_STOCHASTIC__Group_0_2__0");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getGroup_1(), "rule__DSL_CLOCK_STOCHASTIC__Group_1__0");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getGroup_1_2(), "rule__DSL_CLOCK_STOCHASTIC__Group_1_2__0");
					put(grammarAccess.getDSL_FLAG_AUTOSTARTAccess().getGroup(), "rule__DSL_FLAG_AUTOSTART__Group__0");
					...
					put(grammarAccess.getDSL_SENSINACTAccess().getAutostartAssignment_0(), "rule__DSL_SENSINACT__AutostartAssignment_0");
					put(grammarAccess.getDSL_SENSINACTAccess().getResourcesAssignment_1(), "rule__DSL_SENSINACT__ResourcesAssignment_1");
					put(grammarAccess.getDSL_SENSINACTAccess().getProbAssignment_2(), "rule__DSL_SENSINACT__ProbAssignment_2");
					put(grammarAccess.getDSL_SENSINACTAccess().getCepAssignment_3(), "rule__DSL_SENSINACT__CepAssignment_3");
					put(grammarAccess.getDSL_SENSINACTAccess().getOnAssignment_4(), "rule__DSL_SENSINACT__OnAssignment_4");
					put(grammarAccess.getDSL_SENSINACTAccess().getEcaAssignment_5(), "rule__DSL_SENSINACT__EcaAssignment_5");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getRefAssignment_0_1(), "rule__DSL_CLOCK_STOCHASTIC__RefAssignment_0_1");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getRefAssignment_0_2_1(), "rule__DSL_CLOCK_STOCHASTIC__RefAssignment_0_2_1");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getValueAssignment_0_4(), "rule__DSL_CLOCK_STOCHASTIC__ValueAssignment_0_4");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getRefAssignment_1_1(), "rule__DSL_CLOCK_STOCHASTIC__RefAssignment_1_1");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getRefAssignment_1_2_1(), "rule__DSL_CLOCK_STOCHASTIC__RefAssignment_1_2_1");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getParam1Assignment_1_6(), "rule__DSL_CLOCK_STOCHASTIC__Param1Assignment_1_6");
					put(grammarAccess.getDSL_CLOCK_STOCHASTICAccess().getParam2Assignment_1_8(), "rule__DSL_CLOCK_STOCHASTIC__Param2Assignment_1_8");
					put(grammarAccess.getDSL_FLAG_AUTOSTARTAccess().getActivatedAssignment_3(), "rule__DSL_FLAG_AUTOSTART__ActivatedAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.sensinact.studio.language.ui.contentassist.antlr.internal.InternalSensinactParser typedParser = (org.eclipse.sensinact.studio.language.ui.contentassist.antlr.internal.InternalSensinactParser) parser;
