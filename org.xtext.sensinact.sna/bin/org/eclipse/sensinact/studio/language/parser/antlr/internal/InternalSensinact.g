...
entryRuleDSL_CLOCK_STOCHASTIC returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSL_CLOCK_STOCHASTICRule()); }
	 iv_ruleDSL_CLOCK_STOCHASTIC=ruleDSL_CLOCK_STOCHASTIC 
	 { $current=$iv_ruleDSL_CLOCK_STOCHASTIC.current; } 
	 EOF 
;

// Rule DSL_CLOCK_STOCHASTIC
ruleDSL_CLOCK_STOCHASTIC returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((	otherlv_0='use' 
...
entryRuleDSL_FLAG_AUTOSTART returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSL_FLAG_AUTOSTARTRule()); }
	 iv_ruleDSL_FLAG_AUTOSTART=ruleDSL_FLAG_AUTOSTART 
	 { $current=$iv_ruleDSL_FLAG_AUTOSTART.current; } 
	 EOF 
;

// Rule DSL_FLAG_AUTOSTART
ruleDSL_FLAG_AUTOSTART returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='option' 
